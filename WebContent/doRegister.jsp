...
<%
    ...
    String patient_name=request.getParameter("txt_patient_name");
    ...
    String hCard_number=request.getParameter("txt_hCard_number");
    ...
    updateQuery=psdoLogin.executeUpdate();
	    ...
	    if (updateQuery != 0) { 
	    	...
	    	response.sendRedirect("register.jsp?usr="+patient_name+"&pass="+password);
	    }
