...
<form name="frmRegister" onSubmit="return validate();" action="doRegister.jsp" method="post">
  ...
  <table width="400" border="0" align="center">
    <tr>
      ...
      <td width="250" align="left"><input type="text" name="txt_patient_name" id="txt_patient_name" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left">Health Card Number</td>
      <td align="left"><input type="text" name="txt_hCard_number" id="txt_hCard_number" /></td>
    </tr>
    <tr>
